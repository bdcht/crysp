...
vectors_sha3_512 = [(b""    ,b"A69F73CCA23A9AC5C8B567DC185A756E97C982164FE25859E0D1DCC1475C80A615B2123AF1F5F94C11E3E9402C3AC558F500199D95B6D3E301758586281DCD26"),
                  (b"a"   ,b"697F2D856172CB8309D6B8B97DAC4DE344B549D4DEE61EDFB4962D8698B7FA803F4F93FF24393586E28B5B957AC3D1D369420CE53332712F997BD336D09AB02A"),
                  (b"abc" ,b"B751850B1A57168A5693CD924B6B096E08F621827444F70D884F5D0240D2712E10E116E9192AF3C91A7EC57647E3934057340B4CF408D5A56592F8274EEC53F0"),
                 ]
@pytest.mark.parametrize('m,h',vectors_sha3_512)
def test_sha3_001(m,h):
    sha3 = SHA3(512)
    assert sha3(m) == codecs.decode(h,'hex')
